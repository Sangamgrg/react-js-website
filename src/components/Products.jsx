      ...
      <div
        ...
        <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
          ...
          <div className='md:w-2/3 mx-auto'>
            <div>
              <p className='md:w-4/5 text-s, text-neutralGrey mb-8 leading-7'>
              ...
              <div>
                <div className='flex items-center gap-8 flex-wrap'>
                  <img src={company1Img} alt='' className='cursor-pointer' />
                  <img src={company2Img} alt='' className='cursor-pointer' />
                  <img src={company3Img} alt='' className='cursor-pointer' />
                  <img src={company4Img} alt='' className='cursor-pointer' />
                  <img src={company5Img} alt='' className='cursor-pointer' />
                  <img src={company6Img} alt='' className='cursor-pointer' />
